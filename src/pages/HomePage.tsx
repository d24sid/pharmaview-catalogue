            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
                  Browse our comprehensive catalog of quality medicines and
                  healthcare products. Professional service, competitive prices,
                  and reliable supply.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              ...
              products and services to healthcare professionals and
              institutions.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-xl text-white/90">
              Discover thousands of quality pharmaceutical products at
              competitive prices
            </p>
            <Button
              asChild
