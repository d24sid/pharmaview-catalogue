      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Your trusted pharmaceutical dealer providing quality medicines and
              healthcare products with professional service and competitive
              prices.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-6 text-center">
          <p className="text-muted-foreground text-sm">
            © 2025 People Kind Pharma. All rights reserved. | Licensed
            Pharmaceutical Dealer | Powered by
            <a
              href="https://www.ascendons.in/"
              target="_blank"
